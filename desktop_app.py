...
btn_all = tk.Button(app, text="EXECUTE ALL", command=execute_all_scrapers, width=30,background='green',foreground='white')
btn_at = tk.Button(app, text='AT, INC', command=at_scraper_thread, width=30,background='green', foreground='white')
btn_ct = tk.Button(app, text='CENTRE TRUSTEE CORP', command=ct_scraper_thread, width=30,background='green', foreground='white')
...
footer = tk.Label(app, text="Scraping Status", font=("Helvetica", 8), background="black", fg="white", width=30, padx=18, pady=3)
